...
<!--          TODO alphabetise this -->
        <b-navbar-nav class="ml-auto" v-if="$page.props.auth.logged_in">
          <b-nav-item-dropdown text="Admin" right v-if="$page.props.auth.user.admin">
            ...
            <dropdown-link :href="$route('admin.user_roles')" v-if="$page.props.config.roles_enabled">
              User Roles
            </dropdown-link>
            <dropdown-link :href="$route('admin.upload')" v-if="$page.props.config.roles_enabled">
              Bulk Upload Roles
            </dropdown-link>
            <dropdown-link :href="$route('admin.app_del')" v-if="$page.props.config.app_del_enabled">
              App Del
            </dropdown-link>
          </b-nav-item-dropdown>
