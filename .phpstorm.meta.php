...
'app.aliases.File','app.aliases.Gate','app.aliases.Hash','app.aliases.Lang','app.aliases.Log',
...
'app.aliases.View','app.version','app.register_enabled','app.reset_password_enabled','app.roles_enabled',
'app.lunch_slot_calculated','app.lunch_slot_calculated_ratio','app.demo_mode','app.default_role','app.footer_text',
...
'mail.log_channel','queue.default','queue.connections.sync.driver','queue.connections.database.driver','queue.connections.database.table',
...
'queue.connections.beanstalkd.retry_after','queue.connections.beanstalkd.block_for','queue.connections.sqs.driver','queue.connections.sqs.key','queue.connections.sqs.secret',
...
'sentry.profiles_sample_rate','sentry.send_default_pii','sentry.ignore_transactions','sentry.breadcrumbs.logs','sentry.breadcrumbs.cache',
...
'sentry.tracing.missing_routes','sentry.tracing.continue_after_response','sentry.tracing.default_integrations','flare.key','flare.flare_middleware',
...
'livewire.preview-file','ignition.healthCheck','ignition.executeSolution','ignition.updateConfig','api.',
'api.lunch-slots.index','api.lunch-slots.users','api.lunch-slots.claim','api.lunch-slots.un-claim','api.admin.user-roles.index',
'api.admin.user-roles.update','home','demo-mode','password.change','login','logout','register','password.request',
...
'filament::components.section.heading','filament::components.section.index','filament::components.tabs.index','filament::components.tabs.item','laravel-exceptions::401',
